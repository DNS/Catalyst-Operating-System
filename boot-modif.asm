...
CPU 386			; [daniels] Assemble instructions up to the 386 instruction set


USE16			; [daniels] NOT TESTED YET !!!
;BITS 16
...
HelloWorld db 13, 10, 'Welcome to Catalyst Operating System', 13, 10, 'Catalyst v0.0.2 built for IA32-386-realmode', 13, 10, 'Copyright (c) 2009, Daniel Sirait <dns@cpan.org>. All rights reserved.', 13,10, 13,10, \
				'daniels@local ~', 13,10, '$ ', 0
